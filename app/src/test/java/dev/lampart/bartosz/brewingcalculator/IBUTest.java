...
public class IBUTest {
    ...
    public void ibuWholeHops() throws Exception {
        ...
        IBUData ibuData5 = new IBUData(5, 1, WeightUnit.OZ, 10, HopType.WHOLE_HOPS);
        IBUData ibuData7 = new IBUData(7, 2, WeightUnit.OZ,  20, HopType.WHOLE_HOPS);
        IBUData ibuData10 = new IBUData(10, 2, WeightUnit.OZ,  30, HopType.WHOLE_HOPS);
        IBUData ibuData15 = new IBUData(15, 1, WeightUnit.OZ,  60, HopType.WHOLE_HOPS);
    ...
    public void ibuPellets() throws Exception {
        // http://www.hopsteiner.com/ibu-calculator/
        IBUData ibuData5 = new IBUData(5, 1, WeightUnit.OZ, 10, HopType.PELLETS);
        IBUData ibuData7 = new IBUData(7, 2, WeightUnit.OZ, 20, HopType.PELLETS);
        IBUData ibuData10 = new IBUData(10, 2, WeightUnit.OZ, 30, HopType.PELLETS);
        IBUData ibuData15 = new IBUData(15, 1, WeightUnit.OZ, 60, HopType.PELLETS  );
    ...
    @Test
    public void ibuPelletsGram() throws Exception {
        // http://www.hopsteiner.com/ibu-calculator/
        IBUData ibuData5 = new IBUData(5, 28.35, WeightUnit.G, 10, HopType.PELLETS);
        IBUData ibuData7 = new IBUData(7, 56.7, WeightUnit.G, 20, HopType.PELLETS);
        IBUData ibuData10 = new IBUData(10, 56.7, WeightUnit.G, 30, HopType.PELLETS);
        IBUData ibuData15 = new IBUData(15, 28.35, WeightUnit.G, 60, HopType.PELLETS  );
